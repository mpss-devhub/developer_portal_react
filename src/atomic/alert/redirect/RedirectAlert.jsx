...
import { redirect } from "../../diagramText/DiagramText";
  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent className="max-h-[90vh] max-w-[100vh] overflow-y-auto">
        ...
        <p className="text-base mt-4 font-medium">Environment URL</p>
        <p className="text-sm">
          Merchants can use the described base URL for their UAT integration.
          Once the UAT integration is done, you can switch to the Production
          environment with the described URL. Production merchant account
          credentials will be shared by Octoverse Team after the setup
        ...
        <p className="text-base mt-4 font-medium">Merchant Information</p>
        <p className="text-sm">
          Merchant id,secret key and data key which are provided from Octover
          Payment Gateway system to integrate payment gateway in your project.
        </p>
        <Table className="min-w-full text-xs sm:text-sm md:text-base">
          <TableHeader>
            <TableRow>
        ...
        <p className="text-sm">
          Below is the sequenece disagram that explains the redirect payment
